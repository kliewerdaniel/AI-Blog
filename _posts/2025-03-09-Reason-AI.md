...
{% include image.html url="/assets/images/task-decomposition.png" description="Task decomposition breaks complex goals into manageable steps" %}
...
{% include code-header.html label="app/page.module.css" %}
```css
.main {
  display: flex;
